    ...
    <body class="font-sans antialiased">
        <div class="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
            ...
            <main class="container mx-auto px-6 py-20">
                <div class="max-w-4xl mx-auto text-center">
                    <h2 class="text-5xl md:text-6xl font-bold text-gray-900 mb-6">
                        Kelola Catatan Anda dengan
                        <span class="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Lebih Mudah</span>
                    </h2>
            ...
            <footer class="container mx-auto px-6 py-8 mt-20 border-t border-gray-200">
                <p class="text-center text-gray-600">&copy; {{ date('Y') }} SINOTE. All rights reserved.</p>
            </footer>
        </div>
    </body>
</html>
